...
export default function App() {
  return (
    <main className="relative min-h-screen bg-gradient-to-br from-[#0f0f1a] via-[#141421] to-[#0b0b12] text-white overflow-hidden flex flex-col items-center">
      {/* Gradient blobs for background glow */}
      <div className="absolute -top-40 -left-40 w-[500px] h-[500px] bg-[#00e5ff33] blur-[160px] rounded-full"></div>
      <div className="absolute top-60 -right-40 w-[400px] h-[400px] bg-[#ff00ff33] blur-[160px] rounded-full"></div>

      {/* Header */}
      <motion.section
        className="w-full max-w-5xl text-center py-24 px-6"
      ...
      {/* Footer */}
      <footer className="mt-24 text-gray-500 text-sm mb-6">
